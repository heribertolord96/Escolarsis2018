                        ...
                        <tr v-for="alumno in arrayAlumno" :key="alumno.id">
                           <td>
                              ...
                              <i class="icon-pencil"></i>
                               ...
                               <button type="button" class="btn btn-danger btn-sm" @click="eliminarAlumno(alumno.id)">
                                 <i class="icon-trash"></i>
                                 </button>&nbsp;
                              <template v-if="alumno.condicion">
                                 <button type="button" class="btn btn-secondary btn-sm" @click="desactivarAlumno(alumno.id)">
                              ...
                              <button type="button" @click="abrirModal('alumno','detalles',alumno)" class="btn btn-success btn-sm">
                              <i class="icon-eye"></i>
                              </button> &nbsp;
                           </td>
                        ...
                        <div style="overflow-x:auto; border:solid ; min-width:80%" >
                           <table class="table table-bordered table-striped table-sm">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <th>A. Paterno</th>
                                    <td ><input type="text" v-model="apaterno" class="form-control" readonly>  </td>
                                 </tr>
                                 <tr>  
                                 <tr>
                                    <th>A. Materno</th>
                                    <td ><input type="text" v-model="amaterno" class="form-control" readonly>  </td>
                                 </tr>
                                 <tr>
                                    <th>Nombre</th>
                                    <td ><input type="text" v-model="nombre" class="form-control" readonly>  </td>
                                 </tr>
                                 <tr>
                                    <th>Grupo</th>
                                    <td >
                                       <div class="col-md-9">
                                          <select class="form-control" v-model="idgrupo" disabled>
                                 ...
                                 <tr>
                                    ...
                                    <td ><input type="text" v-model="num_ide" class="form-control" readonly>  </td>
                                 </tr>
                                 <tr>
                                    <th>Direccion</th>
                                    <td ><input type="text" v-model="direccion" class="form-control" readonly>  </td>
                                 </tr>
                                 <tr>
                                    <th>Telefono</th>
                                    <td ><input type="text" v-model="telefono" class="form-control" readonly>  </td>
                                 </tr>
                                 <tr>
                                    <th>Email</th>
                                    <td ><input type="text" v-model="email" class="form-control" readonly>  </td>
                                 </tr>
                                 <tr>
                                    <th>F. Nacimiento</th>
                                    <td ><input type="text" v-model="birthday" class="form-control" readonly>  </td>
                                 </tr>
                                 <tr>
                                    <th>Sexo</th>
                                    <td ><input type="text" v-model="sexo" class="form-control" readonly>  </td>
                                 </tr>
                                 <tr>
                                    <th>Nombre de usuario</th>
                                    <td ><input type="text" v-model="usuario" class="form-control" readonly>  </td>
                                 </tr>
                              </tbody>
                           </table>
                        </div>
...
<script>
   export default {      
       ...
       methods : {
              ...
              swal({
               ...
               if (result.value) {
                   ...
                   axios.put('/alumno/destroy',{
                       ...
                       swal(
                       'Eliminado !',
                       'El registro ha sido eliminado,aunque se produjo un error',
                       'error'
                       )
                       console.table(error);
           ...
           desactivarAlumno(id){
              swal({
               title: 'Esta seguro de dar de baja este alumno?',
               type: 'warning',
               showCancelButton: true,
               confirmButtonColor: '#3085d6',
               cancelButtonColor: '#d33',
               ...
               if (result.value) {
                   ...
                   axios.put('/alumno/desactivar',{
                       ...
                       swal(
                       'Desactivado!',
                       'Ahora no se mostrará este alumno para registrar sesiones',
                       'success'
                       )
                   }).catch(function (error) {                       
                       me.listarAlumno(1,'','nombre');
