...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" type="text/css" href="assets/plantilla/css/bootstrap.min.css" >
    <!-- Fonts -->
    <link rel="stylesheet" type="text/css" href="assets/fonts/font-awesome.min.css">
    <!-- Icon -->
    <link rel="stylesheet" type="text/css" href="assets/fonts/simple-line-icons.css">
    <!-- Slicknav -->
    <link rel="stylesheet" type="text/css" href="assets/plantilla/css/slicknav.css">
    <!-- Menu CSS -->
    <link rel="stylesheet" type="text/css" href="assets/plantilla/css/menu_sideslide.css">
    <!-- Slider CSS -->
    <link rel="stylesheet" type="text/css" href="assets/plantilla/css/slide-style.css">
    <!-- Nivo Lightbox -->
    <link rel="stylesheet" type="text/css" href="assets/plantilla/css/nivo-lightbox.css" >
    <!-- Animate -->
    <link rel="stylesheet" type="text/css" href="assets/plantilla/css/animate.css">
    <!-- Main Style -->
    <link rel="stylesheet" type="text/css" href="assets/plantilla/css/main.css">
    <!-- Responsive Style -->
    <link rel="stylesheet" type="text/css" href="assets/plantilla/css/responsive.css">
  </head>
  <body>
    ...
    <script src="assets/plantilla/js/popper.min.js"></script>
    <script src="assets/plantilla/js/bootstrap.min.js"></script>
    <script src="assets/plantilla/js/jquery.mixitup.js"></script>
    <script src="assets/plantilla/js/jquery.counterup.min.js"></script>
    <script src="assets/plantilla/js/waypoints.min.js"></script>
    <script src="assets/plantilla/js/wow.js"></script>
    <script src="assets/plantilla/js/jquery.nav.js"></script>
    <script src="assets/plantilla/js/jquery.easing.min.js"></script>  
    <script src="assets/plantilla/js/nivo-lightbox.js"></script>
    <script src="assets/plantilla/js/jquery.slicknav.js"></script>
    <script src="assets/plantilla/js/main.js"></script>
    <script src="assets/plantilla/js/form-validator.min.js"></script>
    <script src="assets/plantilla/js/contact-form-script.min.js"></script>
    <script src="assets/plantilla/js/map.js"></script>
